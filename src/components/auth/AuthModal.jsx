              ...
              <form onSubmit={handleEmailAuth} className="space-y-3 pt-1">
                <div className="flex items-center justify-between text-xs pb-1">
                  <span className="text-slate-300 font-medium">
                    {emailMode === 'signup' ? 'Create Community Account' : 'Member Sign In'}
                  </span>
                  <button
                    type="button"
                  ...
                  >
                    {emailMode === 'signup' ? 'Have an account? Sign In' : 'Need account? Sign Up'}
                  </button>
                </div>

                {emailMode === 'signup' && (
                  <div className="space-y-1">
                    <label className="text-[11px] text-slate-400 font-sans">Display Name / Moniker</label>
                    <input
                      type="text"
                ...
                >
                  {isSigningIn ? (
                    ...
                    <span>{emailMode === 'signup' ? 'Create Account' : 'Sign In with Email'}</span>
                  )}
                </Button>
              </form>
            )}
